...
const Settings = () => {
  ...
  return (
    <div className="h-full pb-2 md:pb-20">
      <div className="bg-gray-50 dark:bg-neutral-950 p-2 rounded-md shadow-lg text-black dark:text-white h-full max-h-full flex flex-col gap-2 w-full">
        {/* Tabs Section */}
        <div className="flex gap-2 bg-blue-100 dark:bg-neutral-900 p-1 rounded-lg max-w-96 sm:max-w-full scrollbar-hide overflow-x-scroll sm:overflow-clip h-fit">
          <button
